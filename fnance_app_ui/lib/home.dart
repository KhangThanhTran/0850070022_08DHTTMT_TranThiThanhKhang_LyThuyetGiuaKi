...
import 'package:fnance_app_ui/models/contacts.dart';
import 'package:fnance_app_ui/models/transaction.dart';
      ...
      /*body: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/images/sea.jpg"), //Thêm đường dẫn của ảnh
            fit: BoxFit.cover, //Chọn cách thức xử lý kích thước ảnh
          ),
        ),
        ...
        children: [
          ...
          Container(
            ...
            child: ListView.builder(
                ...
                //Bat dau doan nay la su dung file transactions.dart
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          //Gọi hàm contacts ở flie contacts.dart
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Container(
                  ...
                  child: Column(
                    children: [
                      ClipOval( //Gọi ảnh từ danh sach contacts
                        //ClipOval su dung ở đây có tác dụng
                        //Cắt ảnh theo hình tròn (hình oval)
                        child: Image.asset(
